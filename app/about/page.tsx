                ...
                >
                    <div className="w-full md:w-1/2">
                        <p className="text-gray-300 leading-relaxed mb-4 text-sm sm:text-base">
                            Our story began with a passion for food and a desire to share the rich culinary traditions of Pakistan with the world. We believe that food is not just about sustenance it is about connection, culture, and community.
                        </p>
                        <p className="text-gray-300 leading-relaxed mb-4 text-sm sm:text-base">
